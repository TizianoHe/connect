      ...
      <main className="flex-1 max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl px-5 py-4 mb-10">
          ...
          <p className="text-sm text-amber-700">
            This page needs a real Privacy Policy before the site goes live.
            Replace this placeholder with a policy compliant with the Swiss
            nDSG and EU GDPR as applicable.
          </p>
        </div>

        <h1 className="text-3xl font-semibold text-neutral-900 mb-4">Privacy Policy</h1>
        <p className="text-neutral-500 leading-relaxed">
          Full privacy policy content to be written before launch.
        </p>
      </main>
